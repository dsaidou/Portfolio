    ...
    <Container sx={{display:'flex', flexDirection:'column', width:{xs:'100%', md:'60%'}, height:'100%', alignItems:'center', marginTop:5, paddingX:{xs:'2em', md:'0'}}}>
      ...
      <Grid item xs={6} sm={6} md={4} pr={2}>
         <Typography paragraph sx={{cursor:'default'}} mb={3} fontWeight='300' fontSize='0.9em'>Get to know me</Typography>
          ...
          <Typography paragraph sx={{cursor:'default'}}>
          ...
          <Typography paragraph sx={{cursor:'default'}} mb={3}>
        ...
        <Grid item xs={6} sm={6} md={3} mt={{xs:5, md:0, sm:5}} px={4}>
